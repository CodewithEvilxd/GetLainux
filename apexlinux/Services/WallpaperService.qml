...
Singleton {
    ...
    property string wallpaperCacheFile: Quickshell.env("HOME") + "/.cache/evilxd/wallpapers.json"
    property string colorsCacheFile: Quickshell.env("HOME") + "/.cache/evilxd/colors.json"
    property string defaultWallpaper: ""
    property string previewDirectory: Quickshell.env("HOME") + "/.cache/evilxd/wallpreviews_large"
    ...
    function _setWallpaper(screenName, path) {
        ...
        Ipc.copyWallpaper(path, Quickshell.env("HOME") + "/.cache/evilxd/current_wallpaper");
        generateColors(path);
    }
    ...
    function generateColors(path) {
        ...
        var logPath = Quickshell.env("HOME") + "/.cache/evilxd/matugen.log";
    ...
    function refreshWallpapersList() {
        ...
        Ipc.generateThumbnails("/etc/xdg/quickshell/evilxd/Scripts/generate_previews.py", root.defaultDirectory, root.previewDirectory);
        scanningCount = 0;
