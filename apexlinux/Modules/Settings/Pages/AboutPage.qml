...
ColumnLayout {
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    text: "Custom Quickshell config for ApexLinux"
                    font.pixelSize: 13
                    color: Qt.rgba(colors.fg.r, colors.fg.g, colors.fg.b, 0.6)
                }
                ...
                RowLayout {
                    ...
                    ActionPill {
                        icon: ""
                        label: "Repository"
                        url: "https://github.com/codewithevilxd/ApexLinux"
                    }

                    ActionPill {
                        icon: ""
                        label: "Issues"
                        url: "https://github.com/codewithevilxd/ApexLinux/issues"
                    }
    ...
    GridLayout {
        ...
        Repeater {
            model: [{
                "name": "codewithevilxd",
                "url": "https://github.com/codewithevilxd",
                "image": "/etc/xdg/quickshell/evilxd/Assets/logo.svg"
            }]
