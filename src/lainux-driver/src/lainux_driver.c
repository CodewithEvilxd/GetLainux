// todo: here will be driver for GetLainux
/**
 * @brief getlainux driver
 *
...
int main() {
    // download kernel
    DRV_INIT("GetLainux_Wireless_Module");
    ...
    LAIN_LOG("SYSTEM", CLR_CYAN, "GetLainux Kernel Bridge is ready.");
