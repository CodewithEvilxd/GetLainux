...
export function VortexCliDocumentation() {
  return (
      ...
      <div className="container px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link
              href="https://github.com/codewithevilxd/vortex-cli"
              target="_blank"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <a
                href="https://github.com/codewithevilxd/vortex-cli/blob/main/README.md"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://github.com/codewithevilxd/vortex-cli/issues"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 border rounded-lg hover:border-primary/50 transition-colors text-sm"
              >
              ...
              <a
                href="https://github.com/codewithevilxd/vortex-cli/discussions"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 border rounded-lg hover:border-primary/50 transition-colors text-sm"
              >
              ...
              <a
                href="https://github.com/codewithevilxd/vortex-cli/releases"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 border rounded-lg hover:border-primary/50 transition-colors text-sm"
              >
