...
import { Download, Code, Copy, Check, Info } from 'lucide-react'
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="bg-muted p-4 rounded-lg border-2">
                    <code className="block text-base font-mono font-bold text-foreground">git clone https://github.com/codewithevilxd/Nexus.git</code>
                    <code className="block text-base font-mono font-bold text-foreground mt-2">cd Nexus</code>
                  </div>
                </div>
                <div>
                  ...
                  <Button asChild size="lg" className="w-full">
                    <a 
                      href="https://github.com/codewithevilxd/Nexus/archive/refs/heads/main.zip"
                      target="_blank"
              ...
              <div className="flex items-start gap-2 p-3 bg-background border-2 border-border rounded-lg">
                ...
                <div className="text-sm text-foreground space-y-1">
                  ...
                  <ol className="list-decimal list-inside space-y-1 font-semibold text-muted-foreground">
                    ...
                    <li>Make sure you have <code className="px-2 py-1 bg-muted rounded text-sm font-mono">gcc</code> and <code className="px-2 py-1 bg-muted rounded text-sm font-mono">make</code> installed</li>
                    <li>Run <code className="px-2 py-1 bg-muted rounded text-sm font-mono">make</code> to build</li>
                    <li>Install with <code className="px-2 py-1 bg-muted rounded text-sm font-mono">sudo make install</code></li>
                  </ol>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border">
            <CardHeader>
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded bg-purple-500 flex items-center justify-center text-white font-bold text-lg">
                  1
                </div>
                <div className="flex-1">
                  <CardTitle className="text-2xl font-black font-heading mb-2">Build Nexus</CardTitle>
                  <CardDescription className="text-base font-semibold">Compile the engine from source</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <CardHeader>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-base font-semibold">Execute Protocol (.p) files</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
